<%@ Page Title="" Language="C#" MasterPageFile="~/tutor/Tutor.master" AutoEventWireup="true" CodeFile="changePassword.aspx.cs" Inherits="tutor_changePassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server" GroupingText ="Change password" 
        BackColor="White">
        Current password:<br />
